...
public class Fornecedores extends JDialog {
	...
	public Fornecedores() {
		...
		lblTitulo.setFont(new Font("Arial Black", Font.BOLD | Font.ITALIC, 16));
		lblTitulo.setBounds(307, 0, 244, 38);
		panel.add(lblTitulo);
		
		
		
		JPanel panel_1 = new JPanel();
		panel_1.setBounds(0, 478, 823, 38);
		...
		lblID.setBounds(631, 246, 173, 22);
		...
		lblTelefone.setBounds(20, 243, 135, 29);
		getContentPane().add(lblTelefone);
		
		txtSite = new JTextField();
		txtSite.setBackground(SystemColor.control);
		...
		lblCelular.setBounds(196, 242, 165, 29);
		...
		txtCel.setBounds(196, 268, 183, 29);
		...
		txtEmail.setBounds(389, 269, 235, 29);
		...
		lblEmail.setBounds(389, 243, 135, 29);
		...
		btnAdicionar.setIcon(new ImageIcon(Fornecedores.class.getResource("/img/309049_add_user_human_person_plus_icon.png")));
		btnAdicionar.setBounds(284, 399, 68, 68);
		...
		btnApagar.setIcon(new ImageIcon(Fornecedores.class.getResource("/img/trast.png")));
		btnApagar.setContentAreaFilled(false);
		btnApagar.setBorderPainted(false);
		btnApagar.setBounds(362, 399, 68, 68);
		...
		btnEditar.setIcon(new ImageIcon(Fornecedores.class.getResource("/img/2931178_change_edit_pencil_creative_design_icon.png")));
		btnEditar.setContentAreaFilled(false);
		btnEditar.setBorderPainted(false);
		btnEditar.setBounds(206, 399, 68, 68);
		...
		btnNewButton.setIcon(new ImageIcon(Fornecedores.class.getResource("/img/9110490_rubber_icon.png")));
		...
		txtIE.setBounds(196, 353, 183, 29);
		...
		txtVendedor.setBounds(389, 353, 235, 29);
		getContentPane().add(txtVendedor);
		
		JLabel lblNewLabel = new JLabel("Site");
		lblNewLabel.setFont(new Font("Arial", Font.PLAIN, 16));
		lblNewLabel.setBounds(20, 319, 122, 23);
		getContentPane().add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("IE");
		lblNewLabel_1.setFont(new Font("Arial", Font.PLAIN, 16));
		lblNewLabel_1.setBounds(196, 325, 46, 14);
		getContentPane().add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("Vendedor");
		lblNewLabel_2.setFont(new Font("Arial", Font.PLAIN, 16));
		lblNewLabel_2.setBounds(389, 325, 117, 14);
	...
	private void adicionar() {
		...
		if (txtRazao.getText().isEmpty()) {
			...
			// lógica principal
			// CRUD Create
			String create = "insert into fornecedores (razaosocial,nomefantasia, cnpj, logradouro, numero, complemento, cep, bairro, referencia, cidade, uf,  telefone, celular , email, ie, site, vendedor) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
			...
			try {
		        ...
		        pst.setString(17, txtVendedor.getText());
...
private void editar() {
		...
		if (txtRazao.getText().isEmpty()) {
			...
			// logica principal
			// CRUD - Update
			String update = "update fornecedores set razaosocial=?, nomefantasia=?, cnpj=?, logradouro=?, numero=?, complemento=?, cep=?, bairro=?, referencia=?, cidade=?, uf=?, telefone=?, celular=?, email=?, ie=?, site=?, vendedor=?    where idfornecedor=?";
			// trat de exceção
			try {
				// abrir conexão
				con = dao.conectar();
	...
	if (linha >= 0) {
		...
		try {
			...
			if (rs.next()) {
                ...
                txtVendedor.setText(rs.getString(18));
			} else {
